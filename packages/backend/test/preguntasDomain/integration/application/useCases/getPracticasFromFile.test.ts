...
describe('#Test > integration > domains > preguntasDomain > application > usesCases > migration ... ', () => {
	...
	const path = "./test/preguntasDomain/helpers/practicas_20260406.xlsx"
	...
	const getPreguntasFromFileUseCase = new LoadPracticasFromFile(
		excelAdapterService,
		preguntasRepositoryMongoDB,
		categoriasExternasService,
		generadorDePreguntasDePracticaService
	)
